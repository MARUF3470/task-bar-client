...
const Login = () => {
    const [loginError, setLoadingError] = useState('')
    ...
    return (
        <form onSubmit={handleSubmit(handleLogin)} className='w-3/4 lg:w-1/2 mx-auto my-8'>
            ...
            <div className='w-32 mx-auto'>
                <button onClick={handleGoogleLogin} type="button" className="w-full text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Google</button>
            </div>
            <p>Don't you have an account? <Link className='text-green-600' to='/register'>Register</Link></p>
        </form>
    );
};
